...
from main_dashboard.views import home, add_violation, edit_violation, geocode_search, api_violations, api_violation_create, api_violation_update, api_violations, api_violation_delete, api_sync_check
...
urlpatterns = [
    ...
    path("api/violations/<int:pk>/delete/", api_violation_delete, api_sync_check, name="api_violation_delete, api_sync_check"),
